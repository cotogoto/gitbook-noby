...
## 1. ダッシュボード <a href="#id-1-dashboard" id="id-1-dashboard"></a>
...
## 2. チャット <a href="#id-2-chat" id="id-2-chat"></a>
...
## 3. タイムライン <a href="#id-3-timeline" id="id-3-timeline"></a>
...
## 4. リマインド <a href="#id-4-remind" id="id-4-remind"></a>
...
## 5. プロジェクト <a href="#id-5-project" id="id-5-project"></a>

#### **・左サイド > プロジェクト**

### 5-1. プロジェクト集計 <a href="#id-5-1" id="id-5-1"></a>
...
### 5-2. プロジェクト設定 <a href="#id-5-2-project-settings" id="id-5-2-project-settings"></a>
...
## 6. 作業場所 <a href="#id-6-workplace" id="id-6-workplace"></a>

#### **・左サイド > 作業場所**

### **6-1. 作業場所集計** <a href="#id-6-1-workplacesummary" id="id-6-1-workplacesummary"></a>
...
### **6-2. 作業場所設定** <a href="#id-6-2-workplacesettings" id="id-6-2-workplacesettings"></a>
...
## 7. モチベーション <a href="#id-7-motivation" id="id-7-motivation"></a>
...
## **8**. 感情分類 <a href="#id-8-emotion-classification" id="id-8-emotion-classification"></a>
...
## 9. 性格分析 <a href="#id-9-personality-analysis" id="id-9-personality-analysis"></a>
...
## 10. ボット <a href="#id-10-bot" id="id-10-bot"></a>
